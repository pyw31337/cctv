...
class NowJejuCollector:
    ...
    LOCATIONS = {
        "15": {"name": "제주국제공항", "lat": 33.5111, "lng": 126.4928, "url": "http://123.140.197.51/media/contents/live/33", "addr": "제주특별자치도 제주시 공항로 2"},
        ...
        "16": {"name": "성산일출봉", "lat": 33.4585, "lng": 126.9422, "url": "http://123.140.197.51/media/contents/live/34", "addr": "제주특별자치도 서귀포시 성산읍 일출로 284-6"},
